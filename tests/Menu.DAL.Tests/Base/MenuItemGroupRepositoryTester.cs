...
{
    class MenuItemGroupRepositoryTester:Tester<MenuContext>
    {

        public MenuItemGroupRepositoryTester()
        {
            Repository = new MenuItemRelationGroupRepository();//IocHelper.GetObject<IMenuItemRelationGroupRepository<int, MenuItemRelationGroup>>();
            InitContext();
        }
        public IMenuItemRelationGroupRepository<int, MenuItemRelationGroup> Repository { get; set; }
        ...
        private MenuItemRelationGroup GenerateModel()
        {
            return new MenuItemRelationGroup
            {
                Code = "Testitem",
                IsActive = true,
                Name = "Testitem",
