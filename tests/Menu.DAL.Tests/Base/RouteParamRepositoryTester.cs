...
{
    public class RouteParamRepositoryTester:Tester<MenuContext>
    {
        public DbContext Db { get; set; }
        public RouteParamRepositoryTester()
        {
            Repository = new RouteParamRepository();//IocHelper.GetObject<IRouteParamRepository<int, RouteParam, MenuItemRelationRouteValue>>();
            //Db = new MenuContext(Connection);
            InitContext();
        }
        public IRouteParamRepository<int, RouteParam, MenuItemRelationRouteValue> Repository { get; set; }
        [Test]
        ...
        private RouteParam GenerateModel()
        {
