...
{
    class MenuItemRepositoryTester : Tester<MenuContext>
    {
        public IMenuItemRepository<int, MenuItem> Repository { get; set; }

        public MenuItemRepositoryTester()
        {
            Repository = new MenuItemRepository();//IocHelper.GetObject<IMenuItemRepository<int, MenuItem>>();
        ...
        private MenuItem GenerateModel()
        {
            return new MenuItem
            {
                Code = "Testitem",
