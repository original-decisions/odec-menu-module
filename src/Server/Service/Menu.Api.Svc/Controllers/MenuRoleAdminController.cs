...
namespace odec.Menu.WebUI.Controllers
{
    ...
    public class MenuRoleAdminController : Controller
    {
        ...
        private readonly IRouteNameRepository<int, RouteName> _routeNameRepository =
            new RouteNameRepository();
        ...
        private IMenuItemRelationRepository<int, RoleMenuItemRelation, MenuItemRelationRouteValue>
            _menuRelationRepository =
                new MenuItemRoleRelationRepository();
        //  IocHelper.GetObject<IMenuItemRelationRepository<int, RoleMenuItemRelation, MenuItemRelationRouteValue>>();
        ...
        public ActionResult GetMenuRelations(int page, int rows, string sidx, string sord)
        {
            try
            {
                var result = _menuRelationRepository.Get().ToList().Select(it => new
                {
                    ...
                    IsPublic = !it.RoleId.HasValue,
                    RoleName = it.Role == null ? "Is public menu" : it.Role.Name,
